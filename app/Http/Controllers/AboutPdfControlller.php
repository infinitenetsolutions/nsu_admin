...
class AboutPdfControlller extends Controller
{
    /**
    ...
    {
        $aboutpdf = DB::table('pdf')->where('type', 'aboutpdf')->paginate(10);
        return view('aboutpdf.index', ['data' => $aboutpdf, 'url' => $this->slider_url()]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('aboutpdf.update', ["data" => $data, 'url' => $this->slider_url()]);
    }
    ...
    public function update(Request $request)
    {
        ...
        return redirect('aboutpdf')->with('update', 'Data successfully updated');
    }
