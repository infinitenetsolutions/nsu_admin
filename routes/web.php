...
Route::get('career/applied/status/{id}', [CareerController::class, 'career_status'])->middleware('auth')->name('career_status.status');
Route::get('career/applied/delete/{id}', [CareerController::class, 'career_destroy'])->middleware('auth')->name('career_destroy.delete');
