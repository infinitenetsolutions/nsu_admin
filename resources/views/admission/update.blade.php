                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <img width="100"
                                                        src="{{asset('upload/admission/'.$data->header_image)}}" alt="">
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <img width="100" src="{{asset('upload/admission/'.$data->image_name)}}"
                                                        alt="">
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-6">
                                                    <img width="100" src="{{asset('upload/admission/'.$data->image_name1)}}"
                                                        alt="">
