            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('govbody.update') }}" method="POST">
                                <div class="container">
                                    <div class="row">
                                        @csrf
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <input required value="{{ $data->designation }}" name="designation" placeholder="Desingnation" type="text" class="form-control">
            
                                        </div>
                                        <div class="form-group col-sm-4">
                                            <label for="" class="text-dark"> <b>Address</b> </label>
                                            <input required value="{{ $data->address }}" name="address" placeholder="Address" type="text" class="form-control">
