                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-4">
                                                ...
                                                <select required name="page_id" type="text" class="form-control"
                                                    placeholder="Title">
                                                    <option value="{{ $data->page_id }}">{{ $data->page_id }}</option>
                                            ...
                                            <div class="form-group col-sm-4">
                                                ...
                                                <input value="{{ $data->Robots1 }}" required name="Robots1"
                                                    type="text" class="form-control">

                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label for="" class="text-dark"> <b>Robots2</b> </label>
                                                <input value="{{ $data->Robots2 }}" required name="Robots2"
                                                    type="text" class="form-control">

                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label for="" class="text-dark"> <b>googlebot</b> </label>
                                                <input value="{{ $data->googlebot }}" required name="googlebot"
                                                    type="text" class="form-control">

                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label for="" class="text-dark"> <b>Robots3</b> </label>
                                                <input value="{{ $data->Robots3 }}" required name="Robots3"
                                                    type="text" class="form-control">

                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label for="" class="text-dark"> <b>revisit-after </b> </label>
                                                <input value="{{ $data->revisit }}" required name="revisit"
                                                    type="text" class="form-control">

                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label for="" class="text-dark"> <b>author</b> </label>
                                                <input value="{{ $data->author }}" required name="author"
                                                    type="text" class="form-control">

                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label for="" class="text-dark"> <b>subject</b> </label>
                                                <input value="{{ $data->subject }}" required name="subject"
                                                    type="text" class="form-control">
                                            ...
                                            <div class="form-group col-sm-4">
                                                ...
                                                <input value="{{ $data->identifier_URL }}" required
                                                    name="identifier_URL" type="text" class="form-control">

                                            </div>

                                            <div class="form-group col-sm-4">
                                                <label for="" class="text-dark"> <b>msnbot</b> </label>
                                                <input value="{{ $data->msnbot }}" required name="msnbot"
                                                    type="text" class="form-control">

                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label for="" class="text-dark"> <b>Slurp </b> </label>
                                                <input value="{{ $data->Slurp }}" required name="Slurp"
                                                    type="text" class="form-control">

                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label for="" class="text-dark"> <b>directory</b> </label>
                                                <input value="{{ $data->directory }}" required name="directory"
                                                    type="text" class="form-control">

                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label for="" class="text-dark"> <b>language</b> </label>
                                                <input value="{{ $data->language }}" required name="language"
                                                    type="text" class="form-control">
                                            ...
                                            <div class="form-group col-sm-4">
                                                ...
                                                <input value="{{ $data->coverage }}" required name="coverage"
                                                    type="text" class="form-control">

                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label for="" class="text-dark"> <b>copyright</b> </label>
                                                <input value="{{ $data->copyright }}" required name="copyright"
                                                    type="text" class="form-control">

                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label for="" class="text-dark"> <b>rating</b> </label>
                                                <input value="{{ $data->rating }}" required name="rating"
                                                    type="text" class="form-control">

                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label for="" class="text-dark"> <b>classification</b> </label>
                                                <input value="{{ $data->classification }}" required
                                                    name="classification" type="text" class="form-control">

                                            </div>
                                            <div class="form-group col-sm-4">
                                                <label for="" class="text-dark"> <b>canonical</b> </label>
                                                <input value="{{ $data->canonical }}" required name="canonical"
                                                    type="text" class="form-control">
                                            ...
                                            <div class="form-group col-sm-12">
                                                ...
                                                <textarea name="keywords" id="description" class="form-control" placeholder="description">{{ $data->keywords }}</textarea>
