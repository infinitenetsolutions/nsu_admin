    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header text-center">
                <h5 class="modal-title text-dark " id="exampleModalLongTitle"> Add  Placement </h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form action="{{route('placement.insert')}}" method="POST" enctype="multipart/form-data">
                    <div class="container">
                        <div class="row">
                            @csrf
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <input readonly  name="page_type" required type="text" value="placement" class="form-control"
                                    placeholder="Title">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <input required name="title" type="text" class="form-control" placeholder="Url neme ex- placement">
