    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header text-center">
                <h5 class="modal-title text-dark " id="exampleModalLongTitle"> Add About Menu </h5>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <input readonly  name="page_type" required type="text" value="about" class="form-control"
                                    placeholder="Title">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <input required name="title" type="text" class="form-control" placeholder="Enter Url name ">
