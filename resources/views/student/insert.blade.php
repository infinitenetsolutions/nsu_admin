    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header text-center">
                <h5 class="modal-title text-dark " id="exampleModalLongTitle">Add Student Menu </h5>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-4">
                                ...
                                <input readonly  name="page_type" required type="text" value="student" class="form-control"
                                    placeholder="Title">
