                                    ...
                                    <div class="container">
                                        <div class="row">
                                            ...
                                            <div class="form-group col-sm-4">
                                                ...
                                                <input name="fullform" value="{{ $data->fullform }}" type="text"
                                                    class="form-control" placeholder="Full form ">
                                            ...
                                            <div class="form-group col-sm-4">
                                                ...
                                                <input required name="duration" value="{{ $data->duration }}"
                                                    type="text" class="form-control" placeholder=" Fee ">
